                    ...
                    <tr class="tr-hover">
                        ...
                        <td>
                            <!--                            <button type="button" class="btn btn-warning suaMenu" data-toggle="modal" data-target="#exampleModalSua">
                                                            <a href="<%=request.getContextPath()%>/admin/class/edit?id=<%=objL.getMaLop()%>">Edit</a>
                                                        </button>-->
                            <button xoaMenu="" type="button" class="btn btn-danger ">
                                <a class="text-white" onclick="showMess(<%=objL.getMaLop()%>)" href="#">Delete</a>
                            </button> 
                        </td>
                    </tr>
                    <%
                ...
                <div class="modal-body">
                    <form action ="<%=request.getContextPath()%>/admin/class" method="post">
                        <div class="form-group row">
                            <label for="exampleFormControlFile1" class="col-sm-3">Class Name</label>
...
<script>
    ...
    if (option === true) {
        window.location.href = '<%=request.getContextPath()%>/admin/class/delete?id=' + id;
        }
    }
</script>
<!-- /.content-wrapper -->
